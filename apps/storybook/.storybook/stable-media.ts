// Shared by the visual and craft setups: freeze CSS motion, pin remote images
// to one local placeholder, and wait for fonts and images before a story is
// captured or measured.

/** Freezes CSS motion so each story settles into one stable frame. */
...
/** Rewrites remote image URLs to the placeholder from now on. */
export function pinRemoteImages() {
...
/** Waits for both Geist families and every image on the page. */
export async function settleMedia() {
