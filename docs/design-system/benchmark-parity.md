...
| Docs IA / first-use quickstart                             | `warning` | A public quickstart now links beta installation, CSS imports, theme and mode attributes, a first component, preview policy, verification, and next-step references. Full component, accessibility, and governance documentation IA is not yet stable-complete. | `docs/design-system/quickstart.md`<br>`docs/design-system/README.md`<br>`packages/styles/README.md`<br>`packages/ui-react/README.md`<br>`docs/design-system/ui-react-preview-migration.md`                                                                                                            | `Add navigable component reference documentation for the stable candidate surface.`<br>`Add public accessibility guidance tied to component behavior and evidence.`<br>`Add public governance and support documentation without requiring adopters to read internal planning artifacts.` | `documentation`                  |
...
- **Docs IA / first-use quickstart** — Build the stable docs IA around component reference pages, accessibility guidance, and public governance/support documentation. Owner: `documentation`.
