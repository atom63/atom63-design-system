...
describe('InputOTP', () => {
  ...
  it('reflects the controlled value into the slots', () => {
    const { container } = render(
      <InputOTP pushPasswordManagerStrategy="none" maxLength={4} onChange={() => {}} value="12">
        <InputOTPGroup>
          <InputOTPSlot index={0} />
          <InputOTPSlot index={1} />
          <InputOTPSlot index={2} />
  ...
  it('forwards containerClassName + disabled', () => {
    ...
    expect(container.querySelector('.a63-InputOTP')?.classList.contains('custom-x')).toBe(true)
  ...
  it('forwards invalid state to the hidden input that drives visible slot styling', () => {
    ...
    expect(container.querySelector('.a63-InputOTP-input')).toHaveAttribute('aria-invalid', 'true')
  })
  ...
  it('accepts a full pasted code and reports completion', () => {
    ...
    expect(Array.from(container.querySelectorAll('.a63-InputOTP-slot'))).toHaveLength(4)
    expect(container.querySelectorAll('.a63-InputOTP-slot')[3]).toHaveTextContent('4')
  })
  ...
  it('supports deletion and exposes mobile one-time-code input hints', () => {
    ...
    expect(container.querySelectorAll('.a63-InputOTP-slot')[3]).toHaveTextContent('')
  })
